...
// const CATEGORIES = [
//   { id: "Музеи",                 icon: "https://img.icons8.com/ios/50/000000/museum.png" },
//   { id: "Природа",               icon: "https://img.icons8.com/ios/50/000000/nature.png" },
//   { id: "Гастрономия",           icon: "https://img.icons8.com/ios/50/000000/restaurant.png" },
//   { id: "История",               icon: "https://img.icons8.com/ios/50/000000/history.png" },
//   { id: "Шопинг",                icon: "https://img.icons8.com/ios/50/000000/shopping-bag.png" },
//   { id: "Приключения",           icon: "https://img.icons8.com/ios/50/000000/adventure.png" },
//   { id: "Пляжный отдых",         icon: "https://img.icons8.com/ios/50/000000/beach.png" },
//   { id: "Горы",                  icon: "https://img.icons8.com/ios/50/000000/mountains.png" },
//   { id: "Архитектура",           icon: "https://img.icons8.com/ios/50/000000/architecture.png" },
//   { id: "Ночная жизнь",          icon: "https://img.icons8.com/ios/50/000000/night-club.png" },
//   { id: "Семейный отдых",        icon: "https://img.icons8.com/ios/50/000000/family.png" },
//   { id: "Экстремальный туризм",  icon: "https://img.icons8.com/ios/50/000000/extreme-sports.png" },
//   { id: "Культурные мероприятия",icon: "https://img.icons8.com/ios/50/000000/theater.png" },
//   { id: "Фестивали",             icon: "https://img.icons8.com/ios/50/000000/festival.png" },
//   { id: "Фототуризм",            icon: "https://img.icons8.com/ios/50/000000/camera.png" },
//   { id: "Экотуризм",             icon: "https://img.icons8.com/ios/50/000000/eco-tourism.png" },
//   { id: "Активный отдых",        icon: "https://img.icons8.com/ios/50/000000/active.png" },
//   { id: "Оздоровительный отдых", icon: "https://img.icons8.com/ios/50/000000/spa.png" },
//   { id: "Обзорные экскурсии",    icon: "https://img.icons8.com/ios/50/000000/tourist.png" },
// ];
...
const CATEGORIES = [
  ...
  { id: "Приключения",           icon: "https://img.icons8.com/ios/50/000000/adventure.png" },
  { id: "Пляжный отдых",         icon: "https://img.icons8.com/ios/50/000000/beach.png" },
  { id: "Горы",                  icon: "https://img.icons8.com/?size=100&id=25055&format=png&color=000000" },
  { id: "Архитектура",           icon: "https://img.icons8.com/?size=100&id=9XlNNA5gCHns&format=png&color=000000" },
  { id: "Семейный отдых",        icon: "https://img.icons8.com/ios/50/000000/family.png" },
  { id: "Фестивали",             icon: "https://img.icons8.com/ios/50/000000/festival.png" },
  { id: "Фототуризм",            icon: "https://img.icons8.com/ios/50/000000/camera.png" },
  { id: "Экотуризм",             icon: "https://img.icons8.com/?size=100&id=26111&format=png&color=000000" },
  { id: "Активный отдых",        icon: "https://img.icons8.com/?size=100&id=11736&format=png&color=000000" },
  { id: "Оздоровительный отдых", icon: "https://img.icons8.com/ios/50/000000/spa.png" },
              ...
              <div className="tsp-checkboxes">
                {TRANSPORT_OPTIONS.map(t => (
                  <label key={t.value} className={`tsp-checkbox ${transports.includes(t.value) ? "checked" : ""}`}>
                    ...
                    <span className="tsp-checkbox__icon">
                      <img 
                        src={t.icon} 
                        alt={t.label} 
